  ...
  render() {
    ...
    <div className="App-sunrise">
        ...
        <div className="App-sunrise-data">
           <div>Lever: {this.convertToUTCLocalDate(this.state.mySunrise, true)} </div>
           <div>Coucher: {this.convertToUTCLocalDate(this.state.mySunset, false)} </div>
           <div>Durée: {this.state.myDayLength} </div>
      </div>
